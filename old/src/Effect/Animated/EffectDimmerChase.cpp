                            ...
                            const DMX::FixtureGroup &g)
{
    ...
    // Temporal phase advances at the BPM rate (independent of fixture count),
    // measured from this effect's own grid anchor so a tap-sync or rate change
    // re-phases it cleanly. The spatial term spreads m_spread full waves across
    // the selection.
